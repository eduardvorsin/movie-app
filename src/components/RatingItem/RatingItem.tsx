...
export default function RatingItem({
	...
	const classes = [
		...
		isOrdered ? 'md:[counter-increment:list-item_1] before:hidden md:before:inline-block before:content-[counter(list-item,decimal-leading-zero)] before:text-500 lg:before:text-700 before:font-bold before:text-neutral-1000 dark:before:text-dark-neutral-900 before:leading-none before:transition-colors before:duration-150' : '',
		className
	].join(' ');
